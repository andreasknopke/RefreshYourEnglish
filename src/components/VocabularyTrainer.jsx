    ...
    <div className="max-w-4xl mx-auto">
      ...
      {flashcards.length === 0 ? (
        ...
        <>
          ...
          {/* Flashcard */}
          <div 
            className={`relative h-96 cursor-pointer perspective-1000 ${showSuccess ? 'animate-pulse' : ''}`}
            ...
            >
              ...
              <div className="absolute w-full h-full backface-hidden">
                <div className="glass-card h-full flex flex-col items-center justify-center p-8">
                  <div className="text-sm text-gray-500 mb-4">🇩🇪 Deutsch</div>
              ...
              <div className="absolute w-full h-full backface-hidden rotate-y-180">
                <div className="glass-card h-full flex flex-col items-center justify-center p-8 bg-gradient-to-br from-indigo-50 to-purple-50">
                  <div className="text-sm text-gray-500 mb-4">🇬🇧 Englisch</div>
          ...
          {isFlipped && (
            <div className="mt-6 grid grid-cols-4 gap-3">
              <button
                ...
                disabled={reviewing}
                className="bg-red-500 hover:bg-red-600 text-white font-bold py-4 rounded-lg transition-all transform hover:scale-105 disabled:opacity-50"
              >
                <div className="text-2xl mb-1">😵</div>
                <div className="text-xs">Keine Ahnung</div>
              </button>
              <button
                onClick={() => handleReview(3)}
                disabled={reviewing}
                className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-lg transition-all transform hover:scale-105 disabled:opacity-50"
              >
                <div className="text-2xl mb-1">🤔</div>
              ...
              <button
                ...
                disabled={reviewing}
                className="bg-green-500 hover:bg-green-600 text-white font-bold py-4 rounded-lg transition-all transform hover:scale-105 disabled:opacity-50"
              >
                <div className="text-2xl mb-1">😊</div>
              ...
              <button
                ...
                disabled={reviewing}
                className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 rounded-lg transition-all transform hover:scale-105 disabled:opacity-50"
              >
                <div className="text-2xl mb-1">🎯</div>
